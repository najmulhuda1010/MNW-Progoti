              ...
              <div class="col-md-8 col-xs-12 col-sm-12 offset-md-2">   
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control lname" name="zonalcode" placeholder="Zonal Name" required data-parsley-error-message="Please Enter Cluster Code" list="zonals" autocomplete="off">
                    <datalist id="zonals">
                        <?php
                         ...
                         {
                            ?>
                            <option value="<?php echo $row->zonal_code; ?>"></option>
                            <?php
                         }
                 ?>
                </datalist>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control lname" name="clustername" placeholder="Cluster Name" required data-parsley-error-message="Please Enter Cluster Code" list="cluster_name" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control lname" name="clusterid" placeholder="Cluster Code" required data-parsley-error-message="Please Enter Cluster Code" list="cluster_id" autocomplete="off">
                    ...
                    <div class="scrollbar">
                        ...
                        ?>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name = "area[]" id="inlineCheckbox3" value="<?php echo $row->area_id; ?>">
