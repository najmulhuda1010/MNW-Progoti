              ...
              <div class="col-md-8 col-xs-12 col-sm-12 offset-md-2">   
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control uname" id="email" name="email" placeholder="Please Enter Your Email" required data-parsley-error-message="Please Enter Email" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Phone</label>
                    <input type="number" class="form-control phone" id="phone" name="phone" placeholder="Please Enter Your Phone" data-parsley-type="phone" autocomplete="off" required data-parsley-error-message="Please Enter Phone">
                  </div>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" name="userpin" class="form-control" placeholder="Please Enter Your User Pin" required autocomplete="off">
                            </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Device Id</label>
                            <input type="text" name="deviceid" class="form-control" placeholder="Please Enter Your Device Id" autocomplete="off">
                            </div>
                      </div>
                  </div>
                  <div class="form-group">
