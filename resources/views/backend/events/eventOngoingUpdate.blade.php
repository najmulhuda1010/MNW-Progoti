    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Ongoing Event Update</h5>
            </div>
            <!--end::Info-->
        </div>
    </div>
                            ...
                            <input type="hidden" value="{{ $Event->id }}" name="id">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput" name="monitor1" value="{{ $Event->monitor1_code }}" autocomplete="off" list="users1" >
                                        <datalist id="users1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="monitor2" value="{{ $Event->monitor2_code }}" autocomplete="off" list="users2" >
                                        <datalist id="users2">
                                            @foreach ($users as $row)
                                                <option value="{{ $row->user_pin }}"><option>
                                            @endforeach
